...
local TestTab = Page:CreateSection({
    Name = "// Mian Function \\", -- à¸Šà¸·à¹ˆà¸­
    Side = "Left" -- à¸•à¸³à¹à¸«à¸™à¹ˆà¸‡ Left/Right
})

TestTab:AddToggle({
    Name = "Start Kaitun  |  à¸—à¸³à¸‚à¸­à¸‡à¸­à¸²à¸ªà¸ˆà¸°à¸™à¹‰à¸­à¸¢ ",
	Value = true,
...
TestTab:AddToggle({
    Name = "Fast Farm 10-300 | à¸–à¸¶à¸‡300à¸›à¸´à¸”à¸”à¹‰à¸§à¸¢",
	Value = false,
    Callback = function(value)
    _G.Farmfast = true
...
TestTab:AddSlider({
	Name = "Set Fps",
	Value = 10, -- à¸„à¹ˆà¸²à¸—à¸µà¹ˆà¹ƒà¸«à¹‰à¹€à¸¥à¸·à¸­à¸
	Min = 1, -- à¸™à¹‰à¸­à¸¢à¸ªà¸¸à¸”
	Max = 2000, -- à¸¡à¸²à¸à¸ªà¸¸à¸”
	Format = "Set Fps : %s%%",
	Callback = function(value)
		setfpscap(100)
	end
        ...
        while task.wait() do
            pcall(function()
                ...
                if Check_Sword("Cursed Dual Katana") then
                    CursedDualKatana:Set("âœ… | Cursed Dual Katana")
                end
            end)
        end
    end
                ...
                function()
                    for i, v in pairs(
                        ...
                        if v.Name == "Soul Guitar" then
                            SoulGuitar:Set("âœ… | Soul Guitar")
                        end
                        if v.Name == "Serpent Bow" then
                            SerpentBow:Set("âœ… | Serpent Bow")
                        end                                                 
                    end
                end
            )
        ...
        pcall(function()
            for i,v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do
                ...
                if v.Name == "Usoap's Hat" then
                    Usoap_Hat:Set("âœ… | Usoap's Hat")
                end
                if v.Name == "Warrior Helmet" then
                    Warrior_Helmet:Set("âœ… | Warrior Helmet")
                end                
            end
        end)
    end
							...
							if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress","SickMan") == 0 then
								...
								elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress","RichSon") == 1 then
									...
									if (CFrame.new(-910.979736, 13.7520342, 4078.14624).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300 then
										...
										game:GetService("ReplicatedStorage").Re
									end
								end
							else
